...
from user.views import view_friends, friendship_add_friend, friendship_accept, \
...
urlpatterns = [
    ...
    path ('user/user_<int:pk>/profile/', views.profile, name = 'profile' ),
    path ('user/user_<int:pk>/profile_update/', views.profile_update, name = 'profile_update' ),
    path ('user/user_<int:pk>/pwdchange/', views.pwd_change, name = 'pwd_change' ),
